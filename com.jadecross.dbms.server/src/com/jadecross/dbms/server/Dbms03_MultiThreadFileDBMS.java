 ...
 *
 */
public class Dbms03_MultiThreadFileDBMS extends JPanel {
	 ...
	 * Create the panel.
	 */
	public Dbms03_MultiThreadFileDBMS() {
		setLayout(null);
		...
		textArea.setText("- 동시에 여러명의 Client에게만 서비스 가능\r\n- SELECT 시 매번 DISK에 있는 파일에서 DATA를 읽어옴");

		textArea.setBackground(new Color(240, 240, 240));
		textArea.setBounds(259, 30, 386, 37);
		add(textArea);
